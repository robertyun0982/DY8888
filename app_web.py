...
typhoon_list = [
    ...
    {"id": "WP082026", "name_zh": "第08號 馬鞍", "name_cwa": "馬鞍", "name_en": "MA-ON", "lat": 16.5, "lon": 135.2}
]
...
with right_col:
    ...
    if current_ty["id"] == "WP072026":
        ...
        # 8號馬鞍：一路向西偏南穿過呂宋島北部海面
        cwa = [[135.2, 16.5], [132.8, 16.8], [130.4, 17.1], [127.9, 17.3], [125.4, 17.6], [122.8, 17.8], [120.2, 18.1], [117.7, 18.4], [115.1, 18.7], [112.5, 19.0], [109.8, 19.3]]
        ncdr = [[135.2, 16.5], [132.7, 16.7], [130.1, 16.9], [127.5, 17.1], [124.9, 17.3], [122.3, 17.5], [119.7, 17.7], [117.1, 18.0], [114.5, 18.2], [111.9, 18.5], [109.3, 18.8]]
        ecmwf = [[135.2, 16.5], [132.9, 17.0], [130.6, 17.4], [128.2, 17.8], [125.9, 18.2], [123.5, 18.6], [121.0, 19.1], [118.6, 19.5], [116.1, 20.0], [113.6, 20.5], [111.0, 21.0]]
        jtwc = [[135.2, 16.5], [133.0, 17.2], [130.8, 17.8], [128.5, 18.4], [126.2, 19.0], [123.9, 19.6], [121.5, 20.2], [119.1, 20.9], [116.7, 21.5], [114.2, 22.2], [111.6, 22.8]]
        jma = [[135.2, 16.5], [132.8, 16.9], [130.3, 17.2], [127.8, 17.5], [125.3, 17.9], [122.7, 18.2], [120.1, 18.6], [117.5, 19.0], [114.9, 19.4], [112.3, 19.8], [109.6, 20.2]]
        hko = [[135.2, 16.5], [132.7, 16.8], [130.2, 17.1], [127.6, 17.4], [125.0, 17.7], [122.4, 18.0], [119.8, 18.3], [117.2, 18.7], [114.6, 19.0], [112.0, 19.4], [109.4, 19.8]]
        nmc = [[135.2, 16.5], [132.9, 16.9], [130.5, 17.3], [128.0, 17.7], [125.5, 18.1], [123.0, 18.5], [120.5, 18.9], [117.9, 19.4], [115.3, 19.8], [112.7, 20.3], [110.0, 20.8]]
        map_lat, map_lon, map_zoom = 19.0, 125.0, 3.5
    ...
    poi_data = [
        ...
        # 動態根據當前選擇的颱風，在其中心點標註中央氣象署中文名稱
        {"label": f"🌀 中央氣象署命名：{current_ty['name_cwa']}", "lon": base_lon, "lat": base_lat + 0.8}
    ]
    ...
    poi_text_layer = pdk.Layer(
        ...
        get_color=[255, 255, 255], get_size=15, 
        background_color=[0, 0, 0, 180],
        get_alignment_baseline="'center'"
    )
    
    # 使用 mapbox 的 light-v10 樣式（在台灣與亞洲區域會依據瀏覽器語系自動載入中文地名）
